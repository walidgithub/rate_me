...
class AppColors {
  static const Color cPrimary = Color(0xFF4A6CF7);
  static const Color cSecondary = Color(0xFF7D8FFF);
  static const Color cAccent = Color(0xFFF2A900);
  static const Color cBackground = Color(0xFFF7F9FC);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cSuccess = Color(0xFF00C48C);
  static const Color cWarning = Color(0xFFFFB84D);
  static const Color cError = Color(0xFFFF4D4D);
  ...
  static const Color cLevel3 = Color(0xFFA3ABE0);
